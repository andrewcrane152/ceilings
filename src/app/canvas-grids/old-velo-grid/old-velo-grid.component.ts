...
@Component({
  selector: 'app-old-velo-grid',
  templateUrl: './old-velo-grid.component.html',
  styleUrls: ['../canvas-grids.component.scss', './old-velo-grid.component.scss']
})
export class OldVeloGridComponent extends CanvasGridsComponent implements OnInit {
  rows = 10;
  columns = 9;
  adjustmentX = 96;
  adjustmentY = 48;
  ...
  ngOnInit() {
    ...
    this.feature.onBuildOldVeloGrid.subscribe(result => {
  ...
  renderVeloGrid() {
    console.log('renderVeloGrid invoked');
